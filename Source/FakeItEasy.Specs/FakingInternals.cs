namespace FakeItEasy.Specs
{
    ...
    public class FakingInternals
    {
        ...
        public void when_trying_to_fake_invisible_internals(
            Exception exception)
        {
            "when trying to fake invisible internals"._(() =>
            {
                exception = Catch.Exception(() => A.Fake<IInternal>());
            });

            "it should throw an exception with a message containing a hint at using internals visible to attribute"._(() =>
            {
            ...
            Exception exception)
        {
            ...
            "it should throw an exception with a message complaining about accessibility"._(() =>
            {
