...
namespace FakeItEasy.Tests.Expressions
{
    ...
    public class ExpressionCallRuleTests
    {
        ...
        public void SetUp()
        {
            ...
            this.callMatcher = A.Fake<ExpressionCallMatcher>(x => x.WithArgumentsForConstructor(() => new ExpressionCallMatcher(dummyCall, A.Fake<ArgumentValidatorFactory>(), A.Fake<MethodInfoManager>())));
        }
        ...
        public void IsApplicableTo_should_pass_call_to_call_matcher()
        {
            ...
            A.CallTo(() => this.callMatcher.Matches(call)).Assert(Happened.Once);
        }
