namespace FakeItEasy.Tests.Core.Creation
{
    ...
    public class ProxyGeneratorResultTests
    {
        ...
        public void Should_set_that_proxy_was_successfully_created_when_constructor_with_proxy_and_raiser_is_used()
        {
            ...
            // Act
            var result = new ProxyGeneratorResult(A.Fake<IProxy>(), A.Fake<ICallInterceptedEventRaiser>());
        ...
        public void Should_set_event_raiser()
        {
            ...
            // Act
            var result = new ProxyGeneratorResult(A.Dummy<IProxy>(), eventRaiser);
        ...
        public void Constructor_with_proxy_should_be_null_guarded()
        {
            ...
            // Assert
            NullGuardedConstraint.Assert(() =>
                new ProxyGeneratorResult(A.Dummy<IProxy>(), A.Dummy<ICallInterceptedEventRaiser>()));
        }
    }
}
