...
namespace FakeItEasy {
    ...
    internal class ExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The handler on the event raise is not meant to be called directly, only use it to register to an event on a fake object that you want to be raised..
        /// </summary>
        internal static string EventHandlerCalledDirectly {
            get {
                return ResourceManager.GetString("EventHandlerCalledDirectly", resourceCulture);
            }
        }
