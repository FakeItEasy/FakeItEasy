namespace FakeItEasy.Core
{
    ...
    /// multiple threads at once. However, there is no protection against calling the value factory more than once during
    /// concurrent accesses; the last value produced will be cached.
    /// However, once a value has been created and cached, the value factory will not be called again for that key.
    /// </remarks>
