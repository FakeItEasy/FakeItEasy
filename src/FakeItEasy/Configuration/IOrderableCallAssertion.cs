namespace FakeItEasy.Configuration
{
    ...
    public interface IOrderableCallAssertion : IHideObjectMembers
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1716:IdentifiersShouldNotMatchKeywords", MessageId = "Then", Justification = "There's no need for clients to implement the member.")]
