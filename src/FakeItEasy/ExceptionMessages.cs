...
namespace FakeItEasy {
    ...
    internal class ExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Apply method of the ExpressionInterceptor may no be called before the Applicator property has...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Can not create fake of the type '{0}', it's not registered in the current container and the curre...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to An ExpressionCallMatcher can only be created for expressions that represents a method call or a p...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Only abstract classes can be faked using the A.Fake-method that takes an enumerable of objects as...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The member accessor expression must be a lambda expression with a MethodCallExpression or MemberA...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Can not generate fake object for the class since no usable default constructor was found, specify...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Now-method on the event raise is not meant to be called directly, only use it to register to ...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The number of values for out and ref parameters specified does not match the number of out and re...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Expected to find call {0} the number of times specified by the predicate '{1}' but found it {2} t...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The method of the call did not match the method of the recorded call, the recorded sequence is no...
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified method can not be configured since it can not be intercepted by the current IProxyG...
        /// </summary>
