namespace FakeItEasy.Specs
{
    ...
    public static class AssertingCallCountSpecs
    {
        ...
        private static IEnumerable<CallCountAsserter> NonMatchingAssertions()
        {
            return new[]
            {
                new CallCountAsserter(0, call => call.MustHaveHappened(), "at least once but no calls were made"),
                ...
                new CallCountAsserter(0, call => call.MustHaveHappenedOnceExactly(), "exactly once but no calls were made"),
                new CallCountAsserter(2, call => call.MustHaveHappenedOnceExactly(), "exactly once but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappenedOnceExactly(), "exactly once but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappenedOnceOrMore(), "at least once but no calls were made"),
                new CallCountAsserter(2, call => call.MustHaveHappenedOnceOrLess(), "no more than once but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappenedOnceOrLess(), "no more than once but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappenedTwiceExactly(), "exactly twice but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappenedTwiceExactly(), "exactly twice but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappenedTwiceExactly(), "exactly twice but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappenedTwiceOrMore(), "at least twice but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappenedTwiceOrMore(), "at least twice but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappenedTwiceOrLess(), "no more than twice but found it 3 times"),
                new CallCountAsserter(1, call => call.MustHaveHappened(0, Times.Exactly), "exactly 0 times but found it once"),
                new CallCountAsserter(2, call => call.MustHaveHappened(0, Times.Exactly), "exactly 0 times but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(0, Times.Exactly), "exactly 0 times but found it 3 times"),
                new CallCountAsserter(1, call => call.MustHaveHappened(0, Times.OrLess), "no more than 0 times but found it once"),
                new CallCountAsserter(2, call => call.MustHaveHappened(0, Times.OrLess), "no more than 0 times but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(0, Times.OrLess), "no more than 0 times but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(1, Times.Exactly), "exactly 1 times but no calls"),
                new CallCountAsserter(2, call => call.MustHaveHappened(1, Times.Exactly), "exactly 1 times but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(1, Times.Exactly), "exactly 1 times but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(1, Times.OrMore), "at least 1 times but no calls were made"),
                new CallCountAsserter(2, call => call.MustHaveHappened(1, Times.OrLess), "no more than 1 times but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(1, Times.OrLess), "no more than 1 times but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(2, Times.Exactly), "exactly 2 times but no calls"),
                new CallCountAsserter(1, call => call.MustHaveHappened(2, Times.Exactly), "exactly 2 times but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappened(2, Times.Exactly), "exactly 2 times but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(2, Times.OrMore), "at least 2 times but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappened(2, Times.OrMore), "at least 2 times but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappened(2, Times.OrLess), "no more than 2 times but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(3, Times.Exactly), "exactly 3 times but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappened(3, Times.Exactly), "exactly 3 times but found it once"),
                new CallCountAsserter(2, call => call.MustHaveHappened(3, Times.Exactly), "exactly 3 times but found it twice"),
                new CallCountAsserter(4, call => call.MustHaveHappened(3, Times.Exactly), "exactly 3 times but found it 4 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(3, Times.OrMore), "at least 3 times but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappened(3, Times.OrMore), "at least 3 times but found it once"),
                new CallCountAsserter(2, call => call.MustHaveHappened(3, Times.OrMore), "at least 3 times but found it twice"),
                new CallCountAsserter(4, call => call.MustHaveHappened(3, Times.OrLess), "no more than 3 times but found it 4 times"),
                new CallCountAsserter(0, call => call.MustHaveHappenedANumberOfTimesMatching(n => n % 2 == 1), "the number of times specified by the predicate 'n => ((n % 2) == 1)' but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappenedANumberOfTimesMatching(n => n % 2 == 0), "the number of times specified by the predicate 'n => ((n % 2) == 0)' but found it once"),
                new CallCountAsserter(2, call => call.MustHaveHappenedANumberOfTimesMatching(n => n % 2 == 1), "the number of times specified by the predicate 'n => ((n % 2) == 1)' but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappenedANumberOfTimesMatching(n => n % 2 == 0), "the number of times specified by the predicate 'n => ((n % 2) == 0)' but found it 3 times")
            };
        }
    }
}
