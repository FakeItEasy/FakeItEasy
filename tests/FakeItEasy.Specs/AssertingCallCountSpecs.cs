    ...
    public static class AssertingCallCountSpecs
    {
        ...
        private static IEnumerable<CallCountAsserter> NonMatchingAssertions()
        {
            return new[]
            {
                ...
                new CallCountAsserter(0, call => call.MustHaveHappened(1, Times.Exactly), "exactly once but no calls"),
                new CallCountAsserter(2, call => call.MustHaveHappened(1, Times.Exactly), "exactly once but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(1, Times.Exactly), "exactly once but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(1, Times.OrMore), "at least once but no calls were made"),
                new CallCountAsserter(2, call => call.MustHaveHappened(1, Times.OrLess), "no more than once but found it twice"),
                new CallCountAsserter(3, call => call.MustHaveHappened(1, Times.OrLess), "no more than once but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(2, Times.Exactly), "exactly twice but no calls"),
                new CallCountAsserter(1, call => call.MustHaveHappened(2, Times.Exactly), "exactly twice but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappened(2, Times.Exactly), "exactly twice but found it 3 times"),
                new CallCountAsserter(0, call => call.MustHaveHappened(2, Times.OrMore), "at least twice but no calls were made"),
                new CallCountAsserter(1, call => call.MustHaveHappened(2, Times.OrMore), "at least twice but found it once"),
                new CallCountAsserter(3, call => call.MustHaveHappened(2, Times.OrLess), "no more than twice but found it 3 times"),
