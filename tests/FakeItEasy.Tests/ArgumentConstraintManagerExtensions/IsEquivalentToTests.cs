namespace FakeItEasy.Tests.ArgumentConstraintManagerExtensions
{
    ...
    public abstract class IsEquivalentToTestsBase
    ...
    public class IsEquivalentToTestsWithEnumerable : IsEquivalentToTestsBase
    {
        protected override void CreateConstraint(INegatableArgumentConstraintManager<IEnumerable<string?>> scope)
        {
            scope.IsEquivalentTo(new List<object?> { "a", "b", null, "y", "z" });
        }
    }

    public class IsEquivalentToTestsWithParams : IsEquivalentToTestsBase
    {
        protected override void CreateConstraint(INegatableArgumentConstraintManager<IEnumerable<string?>> scope)
        {
            scope.IsEquivalentTo("a", "b", null, "y", "z");
        }
    }
}
